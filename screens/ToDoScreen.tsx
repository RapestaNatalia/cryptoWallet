...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>Follow the instructions on the Readme file.</Text>
      <Text style={styles.description}>Don’t worry, it’s easy! You should have the app
       looking smooth in no time.</Text>
        <PrimaryButton 
            accessibilityHint="Press here to start your session into the app."
            accessibilityLabel="Getting started button."
        title="Get Started" onPress={() => navigation.navigate('Home')} />
    </View>
  );
}
